...
- (void)closeButtonClicked:(UIButton *)button
{
    ...
    if (self.activityDelegate && [self.activityDelegate respondsToSelector:@selector(reductionMovieState)]) {
        [self.activityDelegate reductionMovieState];
    }
}
